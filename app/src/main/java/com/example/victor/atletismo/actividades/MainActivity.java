package com.example.victor.atletismo.actividades;
...
import com.example.victor.atletismo.entidades.AllFragments;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            fragment = new ConsultarAtletas();
            setTitle("Consultar atletas");
        } else if (id == R.id.nav_slideshow) {
            fragment = new RegistroAtletas();
            setTitle("Registrar atletas");
        }
        getSupportFragmentManager().beginTransaction().replace(R.id.contenedor,fragment).commit();
